...
def get_ongoing_course_enrollments():
    cur = connection.cursor()
...
def create_enrollment_list():
    newEnrollmentList = get_active_pubh_users()
    existingEnrollmentList = get_ongoing_course_enrollments()
    user_email_list = []
    try:
